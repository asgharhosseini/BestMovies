...
class GenreMoviesAdapter(genreMovies :List<Data> ):
    RvAdapter<Data, GenreMoviesAdapter.GenreMoviesViewHolder>(genreMovies as ArrayList<Data>) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GenreMoviesViewHolder {
        return GenreMoviesViewHolder(
            LayoutInflater.
                from(parent.context)
    ...
    inner class  GenreMoviesViewHolder(itemView: View): RvViewHolder<Data>(itemView){
